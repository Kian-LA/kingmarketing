      ...
      <section className="py-20 bg-white dark:bg-gray-800">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Here's an example of what you'll receive - a comprehensive analysis with actionable recommendations.
            </p>
          </div>

          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 p-8 rounded-xl shadow-lg border">
              <div className="flex items-center justify-between mb-8">
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Marketing Audit Report</h3>
                  <p className="text-gray-600 dark:text-gray-300">TechStart Pro - SaaS Company</p>
                </div>
                <div className="text-right">
                  <div className="text-3xl font-bold text-red-600">73/100</div>
                  <div className="text-sm text-gray-500">Marketing Score</div>
                </div>
              </div>

              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div>
                  <h4 className="font-bold text-gray-900 dark:text-white mb-4">Key Findings</h4>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                      <span className="text-gray-700 dark:text-gray-300">Conversion Rate</span>
                      <span className="font-bold text-red-600">0.8% (Industry: 2.5%)</span>
                    </div>
                ...
                <div>
                  <h4 className="font-bold text-gray-900 dark:text-white mb-4">Opportunities</h4>
                  <div className="space-y-3">
                    <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                      <div className="font-semibold text-blue-600">Landing Page Optimization</div>
                      <div className="text-sm text-gray-600 dark:text-gray-300">Potential 200% conversion increase</div>
                    </div>
                    <div className="p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                      <div className="font-semibold text-purple-600">Google Ads Optimization</div>
                      <div className="text-sm text-gray-600 dark:text-gray-300">Reduce CPC by 40%</div>
                    </div>
                    <div className="p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                      <div className="font-semibold text-orange-600">Email Marketing Setup</div>
                      <div className="text-sm text-gray-600 dark:text-gray-300">25% additional revenue</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 dark:border-gray-600 pt-6">
                <h4 className="font-bold text-gray-900 dark:text-white mb-4">90-Day Action Plan</h4>
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div className="font-semibold text-gray-900 dark:text-white mb-2">Month 1</div>
                  ...
                  <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div className="font-semibold text-gray-900 dark:text-white mb-2">Month 2</div>
                    <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                      <li>• Launch A/B tests</li>
                      <li>• Optimize ad campaigns</li>
                      <li>• Implement email sequences</li>
                    </ul>
                  </div>
                  <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div className="font-semibold text-gray-900 dark:text-white mb-2">Month 3</div>
                    <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
              ...
              <div className="text-center mt-8">
                <button className="bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition-colors font-semibold flex items-center mx-auto">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-red-100 mb-8">
              Join 500+ businesses who have used our free audit to unlock millions in additional revenue.
            </p>
            <a 
              href="#form"
              className="inline-block bg-white text-red-600 px-8 py-4 rounded-lg hover:bg-gray-100 transition-colors duration-200 font-bold text-lg"
            >
              Get Your Free Audit Now
            </a>
            <p className="text-red-200 text-sm mt-4">
              No credit card required • 48-hour delivery • $2,500 value
            </p>
          </div>
        </div>
      </section>
