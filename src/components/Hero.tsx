            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-white via-blue-50/30 to-purple-50/40 dark:from-gray-800 dark:via-blue-900/20 dark:to-purple-900/20 p-8 rounded-2xl border border-blue-100/50 dark:border-blue-800/30 shadow-xl backdrop-blur-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-4 bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm p-5 rounded-xl shadow-lg border border-white/50 dark:border-gray-600/50 hover:shadow-xl transition-all duration-300">
                    <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center animate-pulse shadow-lg">
                    ...
                    <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-3 py-1 rounded-full text-xs font-bold shadow-sm">TRIGGER</div>
                  </div>

                  {/* Arrow */}
                  <div className="flex justify-center">
                    <div className="w-8 h-8 bg-gradient-to-br from-red-500 to-pink-500 rounded-full flex items-center justify-center shadow-lg animate-bounce">
                  ...
                  <div className="flex items-center space-x-4 bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm p-5 rounded-xl shadow-lg border border-white/50 dark:border-gray-600/50 hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="bg-gradient-to-r from-purple-500 to-violet-500 text-white px-3 py-1 rounded-full text-xs font-bold shadow-sm">PROCESS</div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm p-5 rounded-xl shadow-lg border border-white/50 dark:border-gray-600/50 hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-3 py-1 rounded-full text-xs font-bold shadow-sm">ACTION</div>
                  </div>

                  {/* Results */}
                  <div className="bg-gradient-to-r from-emerald-50 via-blue-50 to-purple-50 dark:from-emerald-900/20 dark:via-blue-900/20 dark:to-purple-900/20 p-6 rounded-xl border border-emerald-200/50 dark:border-emerald-800/30 shadow-lg backdrop-blur-sm">
                    <div className="flex items-center justify-center space-x-6 text-center">
                      ...
                      <div>
                        <div className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">42%</div>
                        <div className="text-xs text-gray-600 dark:text-gray-300">Conversion</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-violet-600 bg-clip-text text-transparent">3.2x</div>
                ...
                {/* Automation Badge */}
                <div className="absolute -top-3 -right-3 bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-2 rounded-full text-xs font-bold animate-pulse shadow-lg border-2 border-white dark:border-gray-800">
                  LIVE
                </div>
                
                {/* Decorative Elements */}
                <div className="absolute -top-2 -left-2 w-4 h-4 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full opacity-60 animate-ping"></div>
                <div className="absolute -bottom-2 -right-2 w-3 h-3 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full opacity-60 animate-ping delay-1000"></div>
              </div>
            </div>

            {/* Floating Elements */}
            <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-red-400 to-pink-400 rounded-full opacity-20 animate-pulse blur-xl"></div>
            <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-gradient-to-br from-blue-400 to-purple-400 rounded-full opacity-15 animate-pulse delay-1000 blur-xl"></div>
            <div className="absolute top-1/2 -left-6 w-16 h-16 bg-gradient-to-br from-emerald-400 to-cyan-400 rounded-full opacity-10 animate-pulse delay-500 blur-lg"></div>
          </div>
        </div>
      </div>
    </section>
